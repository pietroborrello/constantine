//===- SVFAPass.h -- Whole program analysis------------------------------------//
//
...
class SVFAPass: public ModulePass {
...
public:
    ...
    void dumpCalleeStats(llvm::Module *M);
    unsigned getCaleeCount(llvm::Module *M, llvm::CallSite &CS);
    unsigned getCaleeTBCount(llvm::Module *M, llvm::CallSite &CS);
