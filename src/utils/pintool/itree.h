...
// used in the codebase of BluePill
...
/*** For the time being all the code is here as I
 *   am too lazy to write a proper Pin Makefile
 ***/
...
void itree_print(itreenode_t *node, ADDRINT lvl) {
	...
	fprintf(stderr, "Level: %lu , Range: [0x%0lx, 0x%0lx]\n", // TODO drop lx and use cerr
