...
static const uint8_t calc_sb_tbl[512] = {
...
int twofish_setkey(const uint8_t *key, unsigned int key_len, struct twofish_ctx *ctx)
{
	int i, j, k;
	...
	if (key_len != 16)
	{
		return -22; /* unsupported key length */
	}
...
static uint8_t in_key[16] = {0xf8, 0x12, 0x7e, 0x00, 0x00, 0x00, 0x6c, 0x7e, 0x81, 0x93, 0xa5, 0xb7, 0xc9, 0xda, 0xec, 0xfe};
