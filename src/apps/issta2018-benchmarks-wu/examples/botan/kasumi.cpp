...
* KASUMI S-Boxes
*/
const uint8_t KASUMI_SBOX_S7[128] __attribute__((aligned(64))) = {
...
const uint16_t KASUMI_SBOX_S9[512] __attribute__((aligned(64))) = {
...
* KASUMI FI Function
*/
inline uint16_t FI(uint16_t I, uint16_t K) __attribute__((always_inline))
{
   uint16_t D9 = (I >> 7);
   uint8_t D7 = (I & 0x7F);
...
* KASUMI Encryption
*/
void encrypt_n(std::vector<uint16_t> &m_EK, const uint8_t in[], uint8_t out[])
{
...
* KASUMI Decryption
*/
void decrypt_n(std::vector<uint16_t> &m_EK, const uint8_t in[], uint8_t out[])
{
   uint16_t B0 = load_be<uint16_t>(in, 0);
   uint16_t B1 = load_be<uint16_t>(in, 1);
   uint16_t B2 = load_be<uint16_t>(in, 2);
...
* KASUMI Key Schedule
*/
void key_schedule(const uint8_t key[], std::vector<uint16_t> &m_EK, size_t)
{
   static const uint16_t RC[] = { 0x0123, 0x4567, 0x89AB, 0xCDEF,
                                0xFEDC, 0xBA98, 0x7654, 0x3210 };

   std::vector<uint16_t> K(16);
...
static uint8_t in_key[32] = {144, 190, 242, 175, 64, 181, 31, 59, 170, 11, 25, 187, 240, 123, 19, 248, 244, 153, 94, 235, 188, 99, 209, 54, 244, 130, 138, 243, 59, 158, 232, 30};
