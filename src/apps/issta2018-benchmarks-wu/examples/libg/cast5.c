...
static int cast_setkey (void *c, const uint8_t *key, unsigned keylen);
static unsigned int encrypt_block (void *c, uint8_t *outbuf, const uint8_t *inbuf);
static unsigned int decrypt_block (void *c, uint8_t *outbuf, const uint8_t *inbuf);
...
extern void _gcry_cast5_amd64_encrypt_block(CAST5_context *c, uint8_t *outbuf,
					    const uint8_t *inbuf);

extern void _gcry_cast5_amd64_decrypt_block(CAST5_context *c, uint8_t *outbuf,
					    const uint8_t *inbuf);

/* These assembly implementations process four blocks in parallel. */
extern void _gcry_cast5_amd64_ctr_enc(CAST5_context *ctx, uint8_t *out,
				      const uint8_t *in, uint8_t *ctr);

extern void _gcry_cast5_amd64_cbc_dec(CAST5_context *ctx, uint8_t *out,
				      const uint8_t *in, uint8_t *iv);

extern void _gcry_cast5_amd64_cfb_dec(CAST5_context *ctx, uint8_t *out,
				      const uint8_t *in, uint8_t *iv);
...
static void
do_encrypt_block (CAST5_context *context, uint8_t *outbuf, const uint8_t *inbuf)
{
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static void
do_decrypt_block (CAST5_context *context, uint8_t *outbuf, const uint8_t *inbuf)
{
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static void
cast5_amd64_ctr_enc(CAST5_context *ctx, uint8_t *out, const uint8_t *in, uint8_t *ctr)
{
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static void
cast5_amd64_cbc_dec(CAST5_context *ctx, uint8_t *out, const uint8_t *in, uint8_t *iv)
{
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static void
cast5_amd64_cfb_dec(CAST5_context *ctx, uint8_t *out, const uint8_t *in, uint8_t *iv)
{
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static unsigned int
encrypt_block (void *context , uint8_t *outbuf, const uint8_t *inbuf)
{
...
static unsigned int
decrypt_block (void *context, uint8_t *outbuf, const uint8_t *inbuf)
{
  CAST5_context *c = (CAST5_context *) context;
...
extern void _gcry_cast5_arm_encrypt_block(CAST5_context *c, uint8_t *outbuf,
					    const uint8_t *inbuf);

extern void _gcry_cast5_arm_decrypt_block(CAST5_context *c, uint8_t *outbuf,
					    const uint8_t *inbuf);

/* These assembly implementations process two blocks in parallel. */
extern void _gcry_cast5_arm_ctr_enc(CAST5_context *ctx, uint8_t *out,
				      const uint8_t *in, uint8_t *ctr);

extern void _gcry_cast5_arm_cbc_dec(CAST5_context *ctx, uint8_t *out,
				      const uint8_t *in, uint8_t *iv);

extern void _gcry_cast5_arm_cfb_dec(CAST5_context *ctx, uint8_t *out,
				      const uint8_t *in, uint8_t *iv);
...
static void
do_encrypt_block( CAST5_context *c, uint8_t *outbuf, const uint8_t *inbuf )
{
    uint32_t l, r, t;
...
static void
do_decrypt_block (CAST5_context *c, uint8_t *outbuf, const uint8_t *inbuf )
{
    uint32_t l, r, t;
    uint32_t I;
    uint32_t *Km;
...
selftest(void)
{
    ...
    {
	int i;
	uint8_t a0[16] = { 0x01,0x23,0x45,0x67,0x12,0x34,0x56,0x78,
			0x23,0x45,0x67,0x89,0x34,0x56,0x78,0x9A };
	uint8_t b0[16] = { 0x01,0x23,0x45,0x67,0x12,0x34,0x56,0x78,
			0x23,0x45,0x67,0x89,0x34,0x56,0x78,0x9A };
	uint8_t a1[16] = { 0xEE,0xA9,0xD0,0xA2,0x49,0xFD,0x3B,0xA6,
			0xB3,0x43,0x6F,0xB8,0x9D,0x6D,0xCA,0x92 };
	uint8_t b1[16] = { 0xB2,0xC9,0x5E,0xB0,0x0C,0x31,0xAD,0x71,
...
static int
do_cast_setkey( CAST5_context *c, const uint8_t *key, unsigned keylen )
{
...
static int
cast_setkey (void *context, const uint8_t *key, unsigned keylen )
{
  CAST5_context *c = (CAST5_context *) context;
