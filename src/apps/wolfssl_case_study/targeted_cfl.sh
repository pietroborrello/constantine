...
CFLAGS="-O$OPT -fno-unroll-loops -mllvm -x86-cmov-converter=0 -g -fno-delete-null-pointer-checks"
OFLAGS="-O$OPT"
LDFLAGS="-O$OPT -ldl"
fi
...
llvm-link -o $PROJECT_NAME.linked_2.bc $PROJECT_NAME.promoted.bc ../../bin/cfl.bcc ../../bin/dfl.bcc
../opt -dfl -dfl-funcs='.*' -dfl-cfl-funcs='__cfl_.*' -dfl-avx2=1 -dfl-induction-vars=1 -stat=0 -modelConsts -allow-fi-prom=0 -fieldlimit=4294967295 -o $PROJECT_NAME.dfl.bc $PROJECT_NAME.linked_2.bc
